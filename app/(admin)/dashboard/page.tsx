...
import { House, Users, UserSearch, Plus } from "lucide-react";
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="mt-2 h-2 bg-gray-200 rounded">
                        <div
                          className="h-2 bg-hauzzo rounded"
                          style={{
                            width: `${propertyCount ? Math.round((propertyStats.sale / propertyCount) * 100) : 0}%`,
                          }}
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="mt-2 h-2 bg-gray-200 rounded">
                        <div
                          ...
                          style={{
                            width: `${propertyCount ? Math.round((propertyStats.rent / propertyCount) * 100) : 0}%`,
                          }}
                        />
                      </div>
                    </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {formatPrice(propertyStats.avgPrice)}
                  </p>
                </CardContent>
              </Card>
            </div>
                ...
                <CardContent>
                  ...
                  <div className="mt-3">
                    <Link
                      ...
                      className="text-sm text-hauzzo hover:underline"
                    >
                      Ver todas →
                    </Link>
                  </div>
          ...
          <div className="space-y-6">
                  ...
                  {leadsTrend.counts.map((v, i) => (
                    <div key={i} className="flex flex-col items-center gap-1">
                      <div
                        ...
                        style={{
                          height: `${Math.max(8, Math.round((v / (leadsTrend.max || 1)) * 100))}%`,
                        }}
                        title={`${v}`}
                      />
                      <span className="text-[10px] text-gray-500">
                        {leadsTrend.days[i].label}
                      </span>
                    </div>
                  ))}
                </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Últimos clientes interesados en tus propiedades
                </CardDescription>
              </CardHeader>
              <CardContent>
